...
@matpool/svg-sprite/1.0.3 darwin-x64 node-v12.18.3
$ ss --help [COMMAND]
USAGE
  $ ss COMMAND
...
...
_See code: [src/commands/gen.ts](https://github.com/btc8/svg-icons-tool/blob/v1.0.3/src/commands/gen.ts)_
...
_See code: [src/commands/init.ts](https://github.com/btc8/svg-icons-tool/blob/v1.0.3/src/commands/init.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/btc8/svg-icons-tool/blob/v1.0.3/src/commands/serve.ts)_
<!-- commandsstop -->
