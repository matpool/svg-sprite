...
_See code: [src/commands/gen.ts](https://github.com/matpool/svg-sprite/blob/v1.1.1/src/commands/gen.ts)_
...
_See code: [src/commands/init.ts](https://github.com/matpool/svg-sprite/blob/v1.1.1/src/commands/init.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/matpool/svg-sprite/blob/v1.1.1/src/commands/serve.ts)_
<!-- commandsstop -->
