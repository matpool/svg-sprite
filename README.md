...
@matpool/svg-sprite/1.1.0 darwin-x64 node-v14.19.0
$ ss --help [COMMAND]
USAGE
  $ ss COMMAND
...
...
_See code: [src/commands/gen.ts](https://github.com/matpool/svg-sprite/blob/v1.1.0/src/commands/gen.ts)_
...
_See code: [src/commands/init.ts](https://github.com/matpool/svg-sprite/blob/v1.1.0/src/commands/init.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/matpool/svg-sprite/blob/v1.1.0/src/commands/serve.ts)_
<!-- commandsstop -->
